...
public class RelatorioDaSemana extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listView.setAdapter(new EfficientAdapter(this, 4));
	...
	private static class EfficientAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			 ...
			 */
			// coluna.calunaTempoInvestidoTextView.setText(getGerarRelatorio().getTempoAtivades().get(position));
			// coluna.colunaAtividadeTextView.setText(getGerarRelatorio().getNomeAtivades().get(position));
