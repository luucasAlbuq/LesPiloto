...
public class ManipulaBD {
	...
	public Atividade getAtividadePorNome(String nomeAtividade){
		...
		String[] arrayColunas = {CriaBD.NOME_ATIVIDADE,
				"sum(" +CriaBD.TEMPO_ATIVIDADE + ") as " + CriaBD.TEMPO_ATIVIDADE,CriaBD.DATA_ATIVIDADE,CriaBD.PRIORIDADE_ATIVIDADE};
		...
		if(cursor.moveToFirst()){
			...
			String prioridade = cursor.getString(cursor.getColumnIndex(CriaBD.PRIORIDADE_ATIVIDADE));
			Date data = null;
			try {
	...
	public List<Atividade> getAtividadesDaSemana(String dataInicio, String dataFim){
		...
		String[] arrayColunas = {CriaBD.NOME_ATIVIDADE, CriaBD.TEMPO_ATIVIDADE, CriaBD.DATA_ATIVIDADE, CriaBD.PRIORIDADE_ATIVIDADE};
